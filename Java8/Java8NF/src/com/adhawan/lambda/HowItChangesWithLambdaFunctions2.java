...
public class HowItChangesWithLambdaFunctions2 {
	...
	public static void main(String args[]) {
		...
		printConditionally(people, (p) -> p.getLname().startsWith("D"), p-> System.out.println(p));	
		...
		printConditionally(people, (p) -> p.getFname().startsWith("A"), p-> System.out.println(p.getFname()));
	}
