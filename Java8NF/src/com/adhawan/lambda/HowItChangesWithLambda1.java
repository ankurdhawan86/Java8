...
public class HowItChangesWithLambda1 {
	...
	public static void main(String args[]) {
		...
		printConditionally(people, (Person p) -> p.getLname().startsWith("D"));	
		...
		printConditionally(people, (Person p) -> p.getFname().startsWith("A"));
	}
